                            ...
                            <div>
                                <div class="mt-6 border-t border-white/10">
                                    ...
                                    <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0" >
                                        ...
                                        <dd class="mt-1 text-sm/6 text-gray-400 sm:col-span-2 sm:mt-0" x-text="new Intl.DateTimeFormat('en-US', { dateStyle: 'medium', timeStyle: 'short' }).format(new Date(admission.created_at))"></dd>
                                    </div>
                                    <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    ...
                                    <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0" >
                                        ...
                                        <dd class="mt-1 text-sm/6 text-gray-400 sm:col-span-2 sm:mt-0" x-text="new Intl.DateTimeFormat('en-US', { dateStyle: 'medium'}).format(new Date(admission.admission_date))"></dd>
                                    </div>
                                    <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                        <dt class="text-sm/6 font-medium text-white">Discharged Date:</dt>
                                        <dd class="mt-1 text-sm/6 text-gray-400 sm:col-span-2 sm:mt-0" x-text="new Intl.DateTimeFormat('en-US', { dateStyle: 'medium'}).format(new Date(admission.discharge_date))"></dd>
                                    </div>
                                    <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                        <dt class="text-sm/6 font-medium text-white">
                                            ...
                                            <div>
                                                ...
                                                <span x-show="copied && field_copied == 'diagnosis'" class="text-green-700">Copied to diagnosis</span>
                                            </div>
                                        </dt>
                                        <dd class="mt-1 text-sm/6 text-gray-400 sm:col-span-2 sm:mt-0">
                                            <span x-html="admission.final_diagnosis"></span>
                                        </dd>
                                    </div>
                                    <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                        <dt class="text-sm/6 font-medium text-white">
                                            ...
                                            <div>
                                                ...
                                                <span x-show="copied && field_copied == 'test_results'" class="text-green-700">Copied to test result</span>
                                            </div>
                                        </dt>
...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('myData', () => ({
            ...
            copyData(data, field) {
                Livewire.dispatch('update-from-admission', {data: data, field:field})
                this.copied = true;
                this.field_copied = field;
