                ...
                <div>
                    <div class="patient-info">
                        <div class="patient-flex">
                            <div><strong>Name:</strong> {{ $record->patient->full_name }}</div>
                            <div><strong>Date:</strong> {{ now()->format('F j, Y') }}</div>
                        </div>
                        <div class="patient-flex">
                            <div><strong>Address:</strong> {{ $record->patient->address }}</div>
                            <div>
                                <strong>Age:</strong> {{ \Carbon\Carbon::parse($record->patient->birthday)->age }} &nbsp;
                                <strong>Sex:</strong> {{ $record->patient->sex }}
                            </div>
                        </div>
                    </div>
