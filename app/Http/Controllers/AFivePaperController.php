...
class AFivePaperController extends Controller
{
    ...
    public function generate(Request $request, $id)
    {
        ...
        $this->image_header = $request->type !== 'Medical Certificate' ? public_path('storage/' . $consultation->clinic->medcert_header_image) : public_path('storage/' . $consultation->clinic->medcert_header_image);
